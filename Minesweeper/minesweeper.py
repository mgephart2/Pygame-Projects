    ...
    def populate_array(self, difficulty):
        ...
        for i in range(len(self.values)):
            if rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] != 9:
                ...
                if rows[(i//self.sqrt_len)][(i%self.sqrt_len)+1] == 9:
                    rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] += 1
                if rows[(i//self.sqrt_len)][(i%self.sqrt_len)+2] == 9:
                    rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] += 1
                if rows[(i//self.sqrt_len)+1][i%self.sqrt_len] == 9:
                    rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] += 1
                if rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+2] == 9:
                    rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] += 1
                if rows[(i//self.sqrt_len)+2][i%self.sqrt_len] == 9:
                    rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] += 1
                if rows[(i//self.sqrt_len)+2][(i%self.sqrt_len)+1] == 9:
                    rows[(i//self.sqrt_len)+1][(i%self.sqrt_len)+1] += 1
